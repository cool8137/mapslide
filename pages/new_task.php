...
<form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
	...
	<?php if($_GET['listid']) : ?>
		<input type="hidden" class="form-control" name="list_id" value="<?php echo $_GET['listid']; ?>" />
	<?php else : ?>
	<label>List</label>
	<select class="form-control" name="list_id">
	<option class="form-control" value ="0">--Select List--</option>
	...
	<textarea class="form-control" rows="5" cols="50" name="task_body"></textarea><br />
	<label>Due Date</label>
	<input class="form-control" type='date' name='due_date' /><br />
	<input class="form-control" type="submit" value="Create" name="task_submit" />
</form>